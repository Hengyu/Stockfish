...
void MainThread::search() {
  ...
  if (bestThread->rootMoves[0].pv.size() > 1 || bestThread->rootMoves[0].extract_ponder_from_tt(rootPos)) {
      ...
      best_move(bestThread->rootMoves[0].pv[0], bestThread->rootMoves[0].pv[1], bestThread->rootMoves[0].score);
  } else {
      best_move(bestThread->rootMoves[0].pv[0], MOVE_NONE, bestThread->rootMoves[0].score);
  }
  // POP iOS
