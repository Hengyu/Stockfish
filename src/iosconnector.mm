...
//#import "CEngine.h"
//#import "CEngine_Private.h"
//#import "CMove.h"
//#import "CMove_Private.h"
//#import "CPrincipalVariation.h"
//#import "CPrincipalVariation_Private.h"
//#import "CResult.h"
//#import "CSearchedMove.h"
//#import "CScore.h"
...
//        cscore = [[CScore alloc] initWithValue:score * 100 / PawnValueEg mates:NO];
//    } else {
...
void best_move(const Move& best, const Move& ponder, const Value& score, const Score& contempt) {
//    CEngine *engine = [CEngine sharedEngine];
//    CMove *b = [[CMove alloc] initWithMove:best];
//    CMove *p = [[CMove alloc] initWithMove:ponder];
//    Value mg = mg_value(contempt);
//    Value eg = eg_value(contempt);
//    CScore *cscore;
//    if (abs(score) < VALUE_MATE - MAX_PLY) {
//        cscore = [[CScore alloc] initWithValue:score * 100 / PawnValueEg mates:NO];
//    } else {
//        cscore = [[CScore alloc] initWithValue:(score > 0 ? VALUE_MATE - score + 1 : -VALUE_MATE - score) / 2 mates:TRUE];
//    }
//    CResult *r = [[CResult alloc] initWithBestMove:b ponderMove:p score:cscore contempt:CContemptMake(mg, eg)];
//    if (best != MOVE_NONE) {
//        [engine sendResult:r];
//    } else {
